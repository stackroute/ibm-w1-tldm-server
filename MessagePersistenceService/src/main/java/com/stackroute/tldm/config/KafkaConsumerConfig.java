...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ChannelMessage> channelConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ChannelMessage> channelKafkaListenerContainerFactory() {
