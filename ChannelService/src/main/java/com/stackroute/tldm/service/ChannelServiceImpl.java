...
public class ChannelServiceImpl implements ChannelService {
	...
	@Override
	public List<User> findAllChannelUsersByChannelId(String channelId) {
		List<User> allUsers = null;
		Channel fetchChannel = null;
		fetchChannel = channelRepository.findById(channelId).get();
		allUsers = fetchChannel.getChannelUsers();
		return allUsers;
	}
	...
	public boolean removeChannelUser(String channelId, String userId) {
		...
		List<User> channelUser = this.findAllChannelUsersByChannelId(channels.getChannelId());
